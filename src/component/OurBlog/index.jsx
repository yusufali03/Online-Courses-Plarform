  ...
  return (
    <div className="ourBlog">
      <div className="container">
        <div
          className="ourBlog_sectionSub"
          data-aos="fade-up"
          data-aos="fade-up"
        >
          <span className="ourBlog_sectionSub_ourTitle" data-aos="fade-up">
            {t("ourBlog.subtitle")}
          </span>
          <h2 className="ourBlog_sectionSub_ourSub" data-aos="fade-up">
            {t("ourBlog.title")}
            <span className="ourBlog_sectionSub_ourSub_ourLine">
              {t("ourBlog.highlight")}
              <img
                className="ourBlog_sectionSub_ourSub_ourLine_ourLineImg"
                src={line}
                alt=""
              />
            </span>
        ...
        <div className="ourBlog_ourCard">
          <div className="ourBlog_ourCard_ourCol-5" data-aos="fade-up">
            <div className="ourBlog_ourCard_ourCol-5_ourBox">
              <div
                className="ourBlog_ourCard_ourCol-5_ourBox_blogImg"
                data-aos="fade-up"
              >
                <img width="100%" src={blog6} alt="" />
              </div>
              <div
                className="ourBlog_ourCard_ourCol-5_ourBox_blogContent"
                data-aos="fade-up"
              >
                <div className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogList">
                  <div className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogList_listDate">
                    JUNE 4, 2024
                  </div>
                  <button className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogList_listButton">
                    Technical
                  </button>
                </div>
                <h3
                  className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogTitle"
                  data-aos="fade-up"
                >
                  Top 5 Programming Languages to Learn for a Thriving Tech
                  Career
                </h3>
                <p
                  className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogP"
                  data-aos="fade-up"
                >
            ...
            <div
              className="ourBlog_ourCard_ourCol-5_shape25"
              data-aos="fade-up"
            >
              <img src={blog25} alt="" />
            </div>
            ...
            <div className="ourBlog_ourCard_ourCol-5_ourBox" data-aos="fade-up">
              <div className="flexs">
                ...
                <div className="ourBlog_ourCard_ourCol-5_ourBox_blogText">
                  <div
                    className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogList"
                    data-aos="fade-up"
                  >
                    <div className="ourBlog_ourCard_ourCol-5_ourBox_blogContent_blogList_listDate">
                      JUNE 4, 2024
