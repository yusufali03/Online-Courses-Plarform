        ...
        <div className="teamMember">
            <div className="container">
                <div className="teamMember_boxT" data-aos="fade-up">
                    <span className="teamMember_boxT_subTeam" data-aos="fade-up">Team Members </span>
                    <h2 className="teamMember_boxT_subTitleTe" data-aos="fade-up">Meet Out <span
                        className="teamMember_boxT_subTitleTe_meet">Instructors <img
                ...
                <div className="teamMember_col">
                    <div className="teamMember_col_col3" data-aos="fade-up">
                        <div className="teamMember_col_col3_Images" >
                            ...
                            <div className="teamMember_col_col3_Images_social">
                                <div className="teamMember_col_col3_Images_social_share"><FaPlus/></div>
                                <div className="teamMember_col_col3_Images_social_media">
                                    <div className="teamMember_col_col3_Images_social_media_network"><FaFacebookF/>
                                    </div>
                                    <div className="teamMember_col_col3_Images_social_media_network"><FaXTwitter/></div>
                                    <div className="teamMember_col_col3_Images_social_media_network"><FaLinkedinIn/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="teamMember_col_col3" data-aos="fade-up">
                        <div className="teamMember_col_col3_Images">
                            <a href="#">
                                <img className="teamMember_col_col3_Images_one" src={team2} alt=""/>
                            </a>
                            <div className="teamMember_col_col3_Images_social">
                                <div className="teamMember_col_col3_Images_social_share"><FaPlus/></div>
                                <div className="teamMember_col_col3_Images_social_media">
                    ...
                    <div className="teamMember_col_col3" data-aos="fade-up" >
                        <div className="teamMember_col_col3_Images">
                            <a href="#">
                                <img className="teamMember_col_col3_Images_one" src={team4} alt=""/>
                            </a>
                            <div className="teamMember_col_col3_Images_social">
                                <div className="teamMember_col_col3_Images_social_share"><FaPlus/></div>
                                <div className="teamMember_col_col3_Images_social_media">
