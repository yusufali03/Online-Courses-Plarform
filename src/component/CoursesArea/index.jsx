                    ...
                    <div className="coursesArea_headings_boxs main-boxs">
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <h2 className="coursesArea_headings_boxs_col5_subb">Choose Our Top <span
                                ...
                                Courses
                                <img className="coursesArea_headings_boxs_col5_subb_spans_liness" src={line} alt=""/>
                            </span>
                            </h2>
                        </div>
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_but">
                                <button className="coursesArea_headings_boxs_col5_but_buttons">Explore All Courses <img
                                    src={leftSmall} alt=""/></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_coursInfo">
                                ...
                                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                                    ...
                                    <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">Increasing Engagement with Instagram & Facebook</h3>
                        ...
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_coursInfo">
                                ...
                                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                                    ...
                                    <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">Introduction to Color Theory & Basic UI/UX</h3>
                        ...
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_coursInfo">
                                ...
                                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                                    ...
                                    <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">Financial Security Thinking and Principles Theory</h3>
                        ...
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_coursInfo">
                                ...
                                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                                    ...
                                    <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">Logo Design: From Concept to Presentation</h3>
                        ...
                        <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
                            <div className="coursesArea_headings_boxs_col5_coursInfo">
                                ...
                                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                                    ...
                                    <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">Professional Ceramic Molding for Beginners</h3>
