      ...
      <div className="container">
        <div className="teamMembersAbout_subTeam" data-aos={dataAos}>
          ...
          {t("teamMembers.subtitle")}
            <span className="teamMembersAbout_subTeam_teamTitle_teamColor">
            {t("teamMembers.subtitleHighlight")}
              <img
                className="teamMembersAbout_subTeam_teamTitle_teamColor_teamLine"
                src={line}
                alt=""
              />
            </span>
          ...
          <div className="teamMembersAbout_teamRow">
            <div
              className="teamMembersAbout_teamRow_teamCol-3"
              data-aos={dataAos}
            >
              <div className="teamMembersAbout_teamRow_teamCol-3_singleTeam">
                <div className="teamMembersAbout_teamRow_teamCol-3_singleTeam_teamContent">
                  <h3 className="teamMembersAbout_teamRow_teamCol-3_singleTeam_teamContent_teamNames">
                    Karl Clarkson
                  </h3>
                  <p>Instructor</p>
                </div>
                <div
                  className="teamMembersAbout_teamRow_teamCol-3_singleTeam_teamImages"
                  data-aos={dataAos}
                >
                  <img
                    width="100%"
                    ...
                    alt=""
                  />
                  <div className="teamMembersAbout_teamRow_teamCol-3_singleTeam_teamImages_teamSocial">
                    <div className="shareIconTeam">
                      <img src={share} alt="" />
                    </div>
                    <div className="socialListIcon">
                      <a className="teamIconLink" href="#">
                        <FaFacebookF />
                      </a>
                      <a className="teamIconLink" href="#">
                        <FaXTwitter />
