        ...
        <div className="container">
          <div className="testimonialsTwo_nextInfo" data-aos="fade-up">
            <div className="testimonialsTwo_nextInfo_testSub">
              <h2
                className="testimonialsTwo_nextInfo_testSub_nextTitle"
                data-aos="fade-up"
              >
                {t("testimonialsTwo.title")} <br />{" "}
                {t("testimonialsTwo.titleContinuation")}
              </h2>
              <p style={{ marginBottom: "20px" }} data-aos="fade-up">
                {t("testimonialsTwo.description1")} <br />{" "}
                {t("testimonialsTwo.description2")}
              </p>
              <a
                href="#"
                className="hero_card_title_buttonList_btn"
                data-aos="fade-up"
