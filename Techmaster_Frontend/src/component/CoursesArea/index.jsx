    ...
    <div className="coursesArea">
      <div className="container">
        <div className="coursesArea_headings">
          <div className="coursesArea_headings_subTitle" data-aos="fade-up">
            {t("coursesArea.subtitle")}
          </div>
          <div className="coursesArea_headings_boxs main-boxs">
            <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
              <h2 className="coursesArea_headings_boxs_col5_subb">
                {t("coursesArea.title")}
                <span className="coursesArea_headings_boxs_col5_subb_spans">
                  {t("coursesArea.highlight")}
                  <img
                    className="coursesArea_headings_boxs_col5_subb_spans_liness"
                    src={line}
                    alt=""
                  />
                </span>
            ...
            <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
              <div className="coursesArea_headings_boxs_col5_but">
                <button className="coursesArea_headings_boxs_col5_but_buttons">
                  {t("coursesArea.explore_button")}
            ...
            <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
              <div className="coursesArea_headings_boxs_col5_coursInfo">
                <div className="coursesArea_headings_boxs_col5_coursInfo_CoursImg">
                  <img
                    className="coursesArea_headings_boxs_col5_coursInfo_CoursImg_pho"
                    src={coursImg}
                    alt=""
                  />
                </div>
                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                  ...
                  <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">
                  ...
                  <div className="flexs">
                    <div className="coursesArea_headings_boxs_col5_coursInfo_cont_lesson">
                      <div className="coursesArea_headings_boxs_col5_coursInfo_cont_lesson_dark">
                        <img src={lessonBlack} alt="" />2 Lessons
                      </div>
                    </div>
                    <div className="coursesArea_headings_boxs_col5_coursInfo_cont_lesson">
                      <div className="coursesArea_headings_boxs_col5_coursInfo_cont_lesson_dark">
            ...
            <div className="coursesArea_headings_boxs_col5" data-aos="fade-up">
              <div className="coursesArea_headings_boxs_col5_coursInfo">
                ...
                <div className="coursesArea_headings_boxs_col5_coursInfo_cont">
                  ...
                  <h3 className="coursesArea_headings_boxs_col5_coursInfo_cont_basic">
                    Professional Ceramic Molding for Beginners
                  </h3>
