        ...
        <div className="flex">
          ...
          <div className="hero_card">
            <div className="hero_card_animation">
              <img
                className="hero_card_animation_lines"
                src={Lines}
                alt="lines"
              />
              <img
                className="hero_card_animation_triangle"
                src={Burchak}
                alt=""
              />
            </div>
            ...
            <div className="hero_card_title" data-aos="fade-up">
              <p className="hero_card_title_gradient">
                {t("hero.tagline")}
              </p>
              <h2 className="hero_card_title_bigGradient">
                {t("hero.title")}
                <span className="hero_card_title_bigGradient_colors">
                  {t("hero.highlight")}
                  <img
                    className="hero_card_title_bigGradient_colors_lines"
                    src={line}
                    alt=""
                  />
                </span>
              </h2>
              <p className="hero_card_title_des">{t("hero.description")}</p>
              <div className="hero_card_title_dot">
                <img
                  className="hero_card_title_dot_shape"
                  src={shape}
                  alt="shape"
                />
              </div>
          ...
          <div className="hero_box">
            <div className="hero_box_banner">
              <div className="hero_box_banner_dot">
                <img
                  className="hero_box_banner_dot_shape"
                  src={shape}
                  alt="shape"
                />
              </div>
              <img
                className="hero_box_banner_mainBanner"
                data-aos="fade-up"
                width="100%"
                height="100%"
                src={banner}
            ...
            <div className="hero_box_info">
              <div className="hero_box_info_content">
                <h3 className="hero_box_info_content_h33">
                  {t("hero.chat_with_mentor")}
                </h3>
                <span className="hero_box_info_content_dess">
                  {t("hero.find_mentor")}
                </span>
              </div>
